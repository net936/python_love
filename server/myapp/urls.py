...
urlpatterns = [
    ...
    path('admin/feedback/list', views.admin.feedback.list_api),
    path('admin/feedback/delete', views.admin.feedback.delete),
    ...
    path('admin/loginLog/clear', views.admin.loginLog.clear),
    ...
    path('index/order/yes_order', views.index.order.yes_order),
