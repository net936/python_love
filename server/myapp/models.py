...
class Thing(models.Model):
    ...
    shengao = models.CharField(max_length=20, blank=True, null=True)  # 身高
    tizhong = models.CharField(max_length=20, blank=True, null=True)  # 体重
    zhiye = models.CharField(max_length=20, blank=True, null=True)  # 职业
    age = models.CharField(max_length=10, blank=True, null=True)  # 年龄
    sex = models.CharField(max_length=10, blank=True, null=True)  # 性别
    chefang = models.CharField(max_length=50, blank=True, null=True)  # 车房
    address = models.CharField(max_length=50, blank=True, null=True)  # 居住地
    phone = models.CharField(max_length=20, blank=True, null=True)  # 联系方式
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Order(models.Model):
    ...
    thing_a = models.CharField(max_length=20, blank=True, null=True)  # 发起者
    thing_b = models.CharField(max_length=20, blank=True, null=True)  # 接收者
    thing_b_title = models.CharField(max_length=20, blank=True, null=True)  # 接收者姓名
    status = models.CharField(max_length=2, blank=True, null=True)  # 1等待中 2接受 3拒绝
    order_time = models.DateTimeField(auto_now_add=True, null=True)
    receiver_name = models.CharField(max_length=20, blank=True, null=True) # 发起者姓名
    receiver_address = models.CharField(max_length=50, blank=True, null=True)
    receiver_time = models.CharField(max_length=50, blank=True, null=True) # 约会时间
